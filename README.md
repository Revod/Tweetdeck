...
* Name it "Revod-Theme whatever"

### How to install this style

* Name the Style anything you want, but something easy to recognise like *Revod-Theme* would be good.
* Paste the text from `Revod-Theme whatever.css` for the theme you use into the textbox.
...
* Now, open `Revod-Theme whatever.css`
* **IMPORTANT STEP:** Don't replace the styles with the one from Revod-Theme, go down 1-2 lines and paste the Revod-Theme style after the original one.
* Refresh the tab/standalone window with the Chrome Extension, and you now have your style installed!

#### Firefox

* Add the following into the textbox on a single line, before the contents of Revod-Theme.css: 
